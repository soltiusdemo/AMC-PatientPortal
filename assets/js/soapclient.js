...
SOAPClient.responseArrays = [];

SOAPClient.invoke = function(url, method, parameters, _arrays,async, callback)
{
	SOAPClient.responseArrays = _arrays;
	if(async)
...
SOAPClient._node2object = function(node, wsdlTypes)
{
	...
	if(SOAPClient.responseArrays.indexOf(node.nodeName) != -1){
		isarray = true;
	}
	// object node
	if(!isarray)
